...
| ファイル | 行数 | 内容 |
|---------|------|------|
| README.md | 119行 | プロジェクト概要とフォルダ構造説明 |
| CONTRIBUTING.md | 253行 | 開発ガイドラインとGit運用 |
| FOLDER_STRUCTURE.md | 332行 | 完全なフォルダツリーと担当分け例 |
| SETUP.md | 189行 | セットアップ手順とトラブルシューティング |
| WORKFLOW_EXAMPLES.md | 380行 | 5つの実践的ワークフロー例 |
| QUICK_REFERENCE.md | 122行 | よく使うコマンド・パスの早見表 |
